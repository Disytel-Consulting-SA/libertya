...
--20180725-1740 Allocations relacionados con los movimientos deben tener el mismo comportamiento en cuanto al parámetro de docstatus
CREATE OR REPLACE FUNCTION v_documents_org_filtered(
    bpartner integer,
    summaryonly boolean,
    condition character,
...
--20180726-1652 Fix al renombre de la columna ad_org_id cuando se ejecuta con organización parámetro
CREATE OR REPLACE FUNCTION v_documents_org_filtered(
    bpartner integer,
    summaryonly boolean,
    condition character,
