...
import org.openXpertya.print.pdf.text.rtf.RtfMapper;
import org.openXpertya.print.pdf.text.rtf.document.output.RtfDataCache;
import org.openXpertya.print.pdf.text.rtf.document.output.RtfDiskCache;
import org.openXpertya.print.pdf.text.rtf.document.output.RtfMemoryCache;

/**
 * The RtfDocument stores all document related data and also the main data stream.
 * INTERNAL CLASS - NOT TO BE USED DIRECTLY
 *
 * Version: $Id: RtfDocument.java,v  1.0 $
