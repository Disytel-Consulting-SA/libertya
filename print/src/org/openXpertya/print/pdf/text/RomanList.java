...
public class RomanList extends List {
	...
	/*
	 * Wandelt eine Integer-Zahl in rmische Schreibweise um
	 *
	 ...
	 *  XVII = 10+5+1+1=17 
	 *
	 * 2. Eine kleinere Ziffer, die links von einer greren steht, wird abgezogen:
	 * 
	 *  IV = 5-1=4 
	 *  CM = 1000-100=900 
	 *
	 ...
	 *  Diese "Subtraktionsschreibweise" ist erst im Mittelalter allgemein gebruchlich geworden. 
	 *  Vorher wurde oft "IIII" fr "4" geshrieben. 
	 *
	 * 4. Bei mehreren mglichen Schreibweisen wird in der Regel der krzesten der Vorzug gegeben:
	 *
	 *  IC = 99 (auch LXLIX) 
	 ...
	 *  Nach dieser Regel wre die Schreibweise "XCIX" fr "99" der Schreibweise "IC" vorzuziehen. 
	 *
	 * 5. Die rmischen Zahlen V, L und D knnen nicht greren Zahlen voran gestellt werden:
	 *
	 *  XCV = 95 (nicht VC) 
	 * 
	 ...
	 * 
	 *
	 * Zahlen grer als 3.000.000 werden durch Doppelstrich etc. dargestellt.
	 */
