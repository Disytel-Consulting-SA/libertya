...
import org.openXpertya.print.pdf.text.pdf.fonts.FontsResourceAnchor;
    ...
    Type1Font(String afmFile, String enc, boolean emb, byte ttfAfm[], byte pfb[]) throws DocumentException, IOException
    {
        ...
        if (BuiltinFonts14.containsKey(afmFile)) {
            ...
            try {
                ...
                if (is == null) {
                    String msg = afmFile + " not found as resource. (The *.afm files must exist as resources in the package org.openXpertya.print.pdf.text.pdf.fonts)";
                    System.err.println(msg + "\n\n" + RESOURCE_PATH + afmFile + ".afm\n\n");
