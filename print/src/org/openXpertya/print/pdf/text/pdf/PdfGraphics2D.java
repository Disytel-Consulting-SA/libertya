    ...
    protected void doAttributes(AttributedCharacterIterator iter) {
        ...
        for(Iterator iterator = set.iterator(); iterator.hasNext();) {
            ...
            if(textattribute.equals(TextAttribute.FONT)) {
                ...
                Color col = (Color)iter.getAttributes().get(textattribute);
                setColor(col);
            }
            else {
                String s = "only FONT/SIZE/UNDERLINE/SUPERSCRIPT/FROREGROUND supported";
...
//        setPaint(paint, false, 0, 0);
    ...
    private boolean drawImage(Image img, Image mask, AffineTransform xform, Color bgColor, ImageObserver obs) {
        ...
        try {
            org.openXpertya.print.pdf.text.Image image = null;
            if(!convertImagesToJPEG){
                image = org.openXpertya.print.pdf.text.Image.getInstance(img, bgColor);
            }
            else{
            ...
            if (mask!=null) {
                org.openXpertya.print.pdf.text.Image msk = org.openXpertya.print.pdf.text.Image.getInstance(mask, null, true);
                msk.makeMask();
    ...
    private void setPaint(boolean invert, double xoffset, double yoffset, boolean fill) {
        if (paint instanceof Color) {
            ...
            try {
                ...
                org.openXpertya.print.pdf.text.Image image = org.openXpertya.print.pdf.text.Image.getInstance(img, null);
