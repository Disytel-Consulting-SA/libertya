...
public class PdfBarcode extends org.openXpertya.print.pdf.text.Chunk {
    ...
    public PdfBarcode(String ttf, int type, int size, String number) throws org.openXpertya.print.pdf.text.BadElementException, org.openXpertya.print.pdf.text.DocumentException, java.io.IOException {
        super(convertToCode(type, number), new org.openXpertya.print.pdf.text.Font(BaseFont.createFont(ttf, "winansi", true), size));
    }
    ...
    public PdfBarcode(String ttf, int type, int size, long number) throws org.openXpertya.print.pdf.text.BadElementException, org.openXpertya.print.pdf.text.DocumentException, java.io.IOException {
        super(convertToCode(type, String.valueOf(number)), new org.openXpertya.print.pdf.text.Font(BaseFont.createFont(ttf, "winansi", true), size));
    }
    ...
    private static String convertToCode(int type, String number) throws org.openXpertya.print.pdf.text.BadElementException {
        ...
        try {
            switch(type) {
                case CODE39:
                    ...
                    break;
                case UPCA:
                    if (length > 12) throw new org.openXpertya.print.pdf.text.BadElementException("An UPC-A barcode can only encode a 12 digit number (your number was " + number + ").");
                    ...
                    break;
                case EAN13:
                    if (length > 13) throw new org.openXpertya.print.pdf.text.BadElementException("An EAN-13 barcode can only encode a 13 digit number (your number was " + number + ").");
                ...
                case INTERLEAVED_2_OF_5:
                    ...
                    break;
                default:
                    throw new org.openXpertya.print.pdf.text.BadElementException("This type of barcode is not supported yet: " + type);
            }
        }
        catch(NumberFormatException nfe) {
            throw new org.openXpertya.print.pdf.text.BadElementException("NumberFormatException at position " + pos + " in " + number + ": " + nfe.getMessage());
        }
