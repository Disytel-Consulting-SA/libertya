			...
			<div id="center">
				...
				<table class="tablelist">
					<tr> 
						...
						<th>Abierto</th>
						<th>Total</th>
						<th>Nuevo en el mes </th>
						<th>Cerrado en el &uacute;ltimo mes </th>
					</tr>
					<c:forEach items='${info.requestTypes}' var='type'> 
						<tr>
							<td><a href="requestsAll.jsp?R_RequestType_ID=<c:out value='${type.r_RequestType_ID}'/>"><c:out value='${type.name}'/></a></td>
