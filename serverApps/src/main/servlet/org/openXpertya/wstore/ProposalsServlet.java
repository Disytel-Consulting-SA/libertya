...
public class ProposalsServlet extends HttpServlet {
    ...
    public void init( ServletConfig config ) throws ServletException {
        ...
        if( !WebEnv.initWeb( config )) {
            throw new ServletException( "ProposalsServlet.init" );
        }
    }    // init
    ...
    public String getServletInfo() {
        return "OpenXpertya Proposal Search Servlet";
    }    // getServletInfo
    ...
    public static String P_FECHA_MINIMA = "fechaMinimaPresupuesto";

    /** Descripción de Campos */

    public static String P_FECHA_MAXIMA = "fechaMaximaPresupuesto";
...
/*
 *  @(#)ProposalsServlet.java   22.03.06
 * 
 *  Fin del fichero ProposalsServlet.java
 *  
 *  Versión 2.0
 *
 */
