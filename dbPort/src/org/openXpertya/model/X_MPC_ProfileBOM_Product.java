...
/** Modelo Generado por MPC_ProfileBOM_Product
 *  @author Comunidad de Desarrollo openXpertya*         *Basado en Codigo Original Modificado, Revisado y Optimizado de:*         * Jorg Janke 
 *  @version  - 2008-01-03 10:26:36.703 */
public class X_MPC_ProfileBOM_Product extends PO
{
/** Constructor estándar */
public X_MPC_ProfileBOM_Product (Properties ctx, int MPC_ProfileBOM_Product_ID, String trxName)
{
super (ctx, MPC_ProfileBOM_Product_ID, trxName);
/** if (MPC_ProfileBOM_Product_ID == 0)
{
setMPC_ProfileBOM_ID (0);
setMPC_ProfileBOM_Product_ID (0);
setM_Product_ID (0);
}
 */
}
...
protected static KeyNamePair Model = new KeyNamePair(1000002,"MPC_ProfileBOM_Product");
...
{
StringBuffer sb = new StringBuffer ("X_MPC_ProfileBOM_Product[").append(getID()).append("]");
return sb.toString();
}
/** Set UOM.
Unit of Measure */
...
{
set_ValueNoCheck ("MPC_ProfileBOM_Product_ID", new Integer(MPC_ProfileBOM_Product_ID));
}
