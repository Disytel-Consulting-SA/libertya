...
/** Load Constructor */
public X_M_Product_Lines (Properties ctx, ResultSet rs, String trxName)
{
...
{
StringBuffer sb = new StringBuffer ("X_M_Product_Lines[").append(getID()).append("]");
return sb.toString();
}
...
{
set_ValueNoCheck ("M_Product_Lines_ID", new Integer(M_Product_Lines_ID));
}
