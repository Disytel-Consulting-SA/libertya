...
/** Modelo Generado por C_Country_Trl
 *  @author Comunidad de Desarrollo openXpertya*         *Basado en Codigo Original Modificado, Revisado y Optimizado de:*         * Jorg Janke 
 *  @version  - 2009-10-22 14:51:31.058 */
public class X_C_Country_Trl extends PO
{
/** Constructor estándar */
public X_C_Country_Trl (Properties ctx, int C_Country_Trl_ID, String trxName)
{
super (ctx, C_Country_Trl_ID, trxName);
...
/** Load Constructor */
public X_C_Country_Trl (Properties ctx, ResultSet rs, String trxName)
{
...
protected static KeyNamePair Model = new KeyNamePair(616,"C_Country_Trl");
...
{
StringBuffer sb = new StringBuffer ("X_C_Country_Trl[").append(getID()).append("]");
return sb.toString();
}
