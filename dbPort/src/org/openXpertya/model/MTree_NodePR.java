/*
 * @(#)MTree_NodePR.java   12.oct 2007  Versión 2.2
 *
 ...
 *         * Jorg Janke
 *  @version $Id: MTree_NodePR.java,v 1.5 2005/03/11 20:28:36 jjanke Exp $
 */
public class MTree_NodePR extends X_AD_TreeNodePR {
    ...
    public static MTree_NodePR get(MTree_Base tree, int Node_ID) {
        ...
        try {
            ...
            if (rs.next()) {
                retValue	= new MTree_NodePR(tree.getCtx(), rs, null);
            }
...
/*
 * @(#)MTree_NodePR.java   02.jul 2007
 * 
 *  Fin del fichero MTree_NodePR.java
 *  
