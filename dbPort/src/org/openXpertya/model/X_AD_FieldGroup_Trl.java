...
/** Modelo Generado por AD_FieldGroup_Trl
 *  @author Comunidad de Desarrollo openXpertya*         *Basado en Codigo Original Modificado, Revisado y Optimizado de:*         * Jorg Janke 
 *  @version  - 2009-10-22 14:51:26.567 */
public class X_AD_FieldGroup_Trl extends PO
{
/** Constructor estándar */
public X_AD_FieldGroup_Trl (Properties ctx, int AD_FieldGroup_Trl_ID, String trxName)
{
super (ctx, AD_FieldGroup_Trl_ID, trxName);
...
/** Load Constructor */
public X_AD_FieldGroup_Trl (Properties ctx, ResultSet rs, String trxName)
{
...
protected static KeyNamePair Model = new KeyNamePair(415,"AD_FieldGroup_Trl");
...
{
StringBuffer sb = new StringBuffer ("X_AD_FieldGroup_Trl[").append(getID()).append("]");
return sb.toString();
}
