 ...
 * Description:
 ************************************************************************/
DROP TABLE MPC_Product_BOMLine CASCADE CONSTRAINTS;
...
--
ALTER TABLE MPC_Product_BOMLine  ADD CONSTRAINT  MPCProductBOM_MPCProductBOML  
    FOREIGN KEY (MPC_Product_BOM_ID)
    REFERENCES  MPC_Product_BOM (MPC_Product_BOM_ID) ON DELETE CASCADE
;


ALTER TABLE MPC_Product_BOMLine ADD CONSTRAINT MProduct_MPCProductBOML
    FOREIGN KEY (M_Product_ID)
    REFERENCES M_Product(M_Product_ID) ON DELETE CASCADE
;


ALTER TABLE MPC_Product_BOMLine  ADD CONSTRAINT ADClient_MPCProductBOML  
    FOREIGN KEY (AD_Client_ID)
    REFERENCES AD_Client(AD_Client_ID) ON DELETE CASCADE
;

ALTER TABLE MPC_Product_BOMLine  ADD CONSTRAINT  ADOrg_MPCProductBOML  
    FOREIGN KEY ( AD_Org_ID)
    REFERENCES  AD_Org(AD_Org_ID) ON DELETE CASCADE
;

ALTER TABLE MPC_Product_BOMLine  ADD CONSTRAINT  CUOM_MPCProductBOML  
    FOREIGN KEY ( C_UOM_ID)
    REFERENCES  C_UOM (C_UOM_ID) ON DELETE CASCADE
;

ALTER TABLE MPC_Product_BOMLine  ADD CONSTRAINT MAttributeSetI_MPCProductBOML  
