...
import org.openXpertya.JasperReport.DataSource.SalesByHourDataSource;
import org.openXpertya.model.MOrg;
import org.openXpertya.util.Env;

public class LaunchSalesByHour extends JasperReportLaunch {
	...
	protected OXPJasperDataSource createReportDataSource() {
		return new SalesByHourDataSource(getOrgID(), getDateFrom(),
				getDateTo(), get_TrxName());
	}
