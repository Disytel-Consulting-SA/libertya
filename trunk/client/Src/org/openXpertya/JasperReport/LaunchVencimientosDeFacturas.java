...
public class LaunchVencimientosDeFacturas extends JasperReportLaunch {
	...
	protected void loadReportParameters() throws Exception {
		...
		// Subtotales Por
		addReportParameter("subtotales_por", getSubtotalesPor());
	}
	...
	/**
	 * @return por lo cual se requiere subtotal
	 */
	private String getSubtotalesPor() {
		if (new String("Fecha")
				.equals((String) getParameterValue("subtotales_por")))
			return "Fecha";
		else
			return "Entidad Comercial";
	}
	...
	protected OXPJasperDataSource createReportDataSource() {
		return new VencimientoDeFacturasDataSource(getCtx(), getDateFrom(),
				...
				getTrxType(), get_TrxName(), getSubtotalesPor());
	}
