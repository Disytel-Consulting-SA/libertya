...
//        Env.setContext(Env.getCtx(), "#AD_Language", AD_LANGUAGE);  <- comentado para que no imprima el reporte en pantalla
		...
		for (int i = 0; i < TPV_SIMULATIONS; i++)
		{
			...
			{
				Product aProduct = new Product(1032483, "999-999", "ART-LIB", BigDecimal.ONE, BigDecimal.ONE, 0, "---",
						true, false, false, 1010402, new ArrayList<Integer>(), "B", true, 0, 0, BigDecimal.ZERO,
						BigDecimal.ZERO);      
