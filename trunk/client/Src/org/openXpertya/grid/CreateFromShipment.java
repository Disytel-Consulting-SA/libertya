...
public class CreateFromShipment extends CreateFrom 
{
	...
	protected KeyNamePair getLocatorKeyNamePair(int M_Locator_ID)
	{
		...
		if (locator != null)
		{
			pp = new KeyNamePair(locator.getID(), locator.getValue());
		}
		return pp;
	}
		...
		*/
			...
			if (((Boolean)miniTable.getValueAt(i, 0)).booleanValue()) {
				...
				if (M_Product_ID == 0)
				{
					/*if (ol != null && ol.getC_Charge_ID() != 0)			//	from order
						...
						iol.setC_Charge_ID(rmal.getC_Charge_ID());TODO Hernandez*/
				}
				// Set locator
		...
		if (p_order != null && p_order.getC_Order_ID() != 0)
		{
			...
			if ( p_order.isDropShip() )
			{
				...
				inout.setDropShip_User_ID(p_order.getDropShip_User_ID()); TODO Hernandez*/
			}
		}
		...
		if (m_rma != null && m_rma.getM_RMA_ID() != 0)
		{
			...
			//TODO Hernandezinout.setIsSOTrx(m_rma.isSOTrx());
