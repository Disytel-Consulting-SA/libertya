...
public class VLookupBeanInfo extends SimpleBeanInfo {

    /** Descripción de Campos */

    private Class beanClass = VLookup.class;
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor[] pds = new PropertyDescriptor[] {
                _background,_display,_editable,_foreground,_mandatory,_value
            };
...
/*
 *  @(#)VLookupBeanInfo.java   02.07.07
 * 
 *  Fin del fichero VLookupBeanInfo.java
 *  
 *  Versión 2.2
 *
 */
