...
import org.openXpertya.apps.BinaryAttachment;
...
public final class VBinary extends JComponent implements VEditor,ActionListener,KeyListener,FocusListener {
    ...
    public VBinary() {
        this( "Binary",false,false,true,DisplayType.Binary,"Binary" );
    }    // VNumber
    ...
    public VBinary( String columnName,boolean mandatory,boolean isReadOnly,boolean isUpdateable,int displayType,String title) {
        super();
...
//              setMinimumSize(new Dimension (30,height));
        ...
        m_button.setIcon( Env.getImageIcon( "Import16.gif" ));
    ...
    public VBinary( String columnName,boolean mandatory,boolean isReadOnly,boolean isUpdateable,int displayType,String title,int D_File_Archive_ID,int D_File_ID, MTab mTab ) {
        super();
        super.setName( columnName );
        m_columnName = columnName;
        m_title      = title;
        setDisplayType( displayType );
        d_file_id=D_File_ID;
        log.fine("en el constructor de VBinary, archive_id="+mTab.getRecord_ID());
        mtab=mTab;
        d_file_archive_id=D_File_Archive_ID;
       // m_window_no=windowno;
        //
...
//              setMinimumSize(new Dimension (30,height));
    ...
    /** Descripción de Campos */
    private int d_file_archive_id;
    private int d_file_id;
  ...
  /*  public Object minus( int minimum ) {
    ...
    public void actionPerformed( ActionEvent e ) {
        ...
        if( e.getSource() == m_button ) {
           ...
           // String str = startAttachment( this,m_text.getText(),m_format,m_displayType,m_title );
           log.fine("En VBinary, el D_File_Archive_ID="+d_file_archive_id+", y d_file_id="+d_file_id);
            BinaryAttachment va = new BinaryAttachment( Env.getFrame( this ),m_window_no,d_file_archive_id,d_file_id,null,mtab );
            log.fine("Lo que tiene el getFileName esssssssssssss"+va.getFileName(1));
            m_mField.setValue("Archivo adjunto",true);
           // m_text.setText( str );
   ...
   /* public static String startAttachment( Container jc,String value,DecimalFormat format,int displayType,String title ) {
