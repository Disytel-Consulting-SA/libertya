...
public class VLineBeanInfo extends SimpleBeanInfo {

    /** Descripción de Campos */

    private Class beanClass = VLine.class;
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            _header.setDisplayName( "header" );
            _header.setShortDescription( "header" );

            PropertyDescriptor[] pds = new PropertyDescriptor[]{ _header };
...
/*
 *  @(#)VLineBeanInfo.java   02.07.07
 * 
 *  Fin del fichero VLineBeanInfo.java
 *  
 *  Versión 2.2
 *
 */
