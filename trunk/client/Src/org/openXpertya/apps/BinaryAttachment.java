...
import org.openXpertya.model.M_D_File_Archive;
...
public final class BinaryAttachment extends JDialog implements ActionListener {
    ...
    public BinaryAttachment( Frame frame,int WindowNo,int D_File_Archive_ID,int D_File_ID,String trxName,MTab mTab ) {
    ...
    private M_D_File_Archive m_attachment;
    ...
    private static CLogger log = CLogger.getCLogger( BinaryAttachment.class );
