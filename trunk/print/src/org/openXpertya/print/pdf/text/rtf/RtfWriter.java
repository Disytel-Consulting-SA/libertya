...
import org.openXpertya.print.pdf.text.DocWriter;
...
public class RtfWriter extends DocWriter implements DocListener {
        ...
        try {
            switch (element.type()) {
                ...
                case Element.SECTION:
                    ...
                    break;
                case Element.LIST:
                    writeList((org.openXpertya.print.pdf.text.List) element, out);
                    break;
                case Element.TABLE:
     ...
     * @throws    DocumentException
     */
    private void writeList(org.openXpertya.print.pdf.text.List list, ByteArrayOutputStream out) throws IOException, DocumentException {
        int type = 0;
        int align = 0;
        ...
        while (listItems.hasNext()) {
            ...
            if (listElem.type() == Element.LISTITEM) {
                ...
                listLevel++;
                writeList((org.openXpertya.print.pdf.text.List) listElem, out);
                listLevel--;
                out.write(escape);
                out.write(paragraphDefaults);
                out.write(escape);
