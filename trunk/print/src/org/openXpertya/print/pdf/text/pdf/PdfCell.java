 ...
 * <P>
 * When using variable borders ({@link org.openXpertya.print.pdf.text.Rectangle#isUseVariableBorders isUseVariableBorders()} == true),
 ...
 * cells.
 *
 * @see		org.openXpertya.print.pdf.text.Rectangle
 * @see		org.openXpertya.print.pdf.text.Cell
 * @see		PdfLine
 * @see		PdfTable
 */
...
public class PdfCell extends Rectangle {
     ...
     * @param side the side to check.  One of the side constants in {@link org.openXpertya.print.pdf.text.Rectangle}
     */
