...
<html>
	...
	<body onLoad="initClock()">
		...
		<c:if test='${empty invoice}'>
			...
			<c:redirect url='invoiceScheduleDetails.jsp'/>
		</c:if>
		<div id="wrap">
			...
			<div id="center">
				...
				<table class="tablelist">
					...
					<tr> 
						...
						<td align="right"><fmt:formatNumber value='${invoice.totalLines}' type="currency" currencySymbol=""/> <c:out value='${invoice.currencyISO}'/></td>
						<td align="right"><fmt:formatNumber value='${invoice.grandTotal}' type="currency" currencySymbol=""/> <c:out value='${invoice.currencyISO}'/></td>
						<td align="right"><fmt:formatNumber value='${invoice.openAmt}' type="currency" currencySymbol=""/> <c:out value='${invoice.currencyISO}'/></td>
				...
				<table class="tablelist">
					...
					<c:choose>
						...
						<td align="right"><fmt:formatNumber value='${vencimiento.dueAmt}' type="currency" currencySymbol=""/> <c:out value='${vencimiento.currencyISO}'/></td>
					</tr>
					</c:forEach>
				</table>
				<!--[if IE]> </div> <![endif]-->
