/*
 * @(#)PlafRes_ml.java   12.oct 2007  Versión 2.2
 *
...
public class PlafRes_ml extends ListResourceBundle {
    ...
    static final Object[][]	contents	= new String[][] {
        ...
        { "BackColType", "Jenis Warna Latar Belakang" }, { "BackColType_Flat", "Flat" }, { "BackColType_Gradient", "Gradient" }, { "BackColType_Lines", "Lines" }, { "BackColType_Texture", "Texture" },

        //
        { "LookAndFeelEditor", "Look & Feel Editor" }, { "LookAndFeel", "Look & Feel" }, { "Theme", "Theme" }, { "EditCompiereTheme", "Edit OpenXpertya Theme" }, { "SetDefault", "Default Background" }, { "SetDefaultColor", "Background Color" }, { "ColorBlind", "Color Deficiency" }, { "Example", "Example" }, { "Reset", "Reset" }, { "OK", "OK" }, { "Cancel", "Batal" },
...
//      { "SmallFontInfo",          "Reports" },
        ...
        //
        { "FontChooser", "Font Chooser" }, { "Fonts", "Fonts" }, { "Plain", "Plain" }, { "Italic", "Italic" }, { "Bold", "Bold" }, { "BoldItalic", "Bold & Italic" }, { "Name", "Name" }, { "Size", "Size" }, { "Style", "Style" }, { "TestString", "This is just a Test! The quick brown Fox is doing something. 12,3456.78 LetterLOne = l1 LetterOZero = O0" }, { "FontString", "Font" },
...
/*
 * @(#)PlafRes_ml.java   02.jul 2007
 * 
 *  Fin del fichero PlafRes_ml.java
 *  
