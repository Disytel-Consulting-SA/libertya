/*
 * @(#)CompiereTabbedPaneUI.java   12.oct 2007  Versión 2.2
 *
 ...
 *         *     Jorg Janke
 *  @version    $Id: CompiereTabbedPaneUI.java,v 1.18 2005/03/11 20:34:36 jjanke Exp $
 */
public class CompiereTabbedPaneUI extends MetalTabbedPaneUI {
    ...
    protected int calculateTabWidth(int tabPlacement, int tabIndex, FontMetrics metrics) {
        ...
        width	+= Math.max(SwingUtilities.computeStringWidth(metrics, firstLine), SwingUtilities.computeStringWidth(metrics, secondLine));
    ...
    protected void layoutLabel(int tabPlacement, FontMetrics metrics, int tabIndex, String title, Icon icon, Rectangle tabRect, Rectangle iconRect, Rectangle textRect, boolean isSelected) {
        ...
        SwingUtilities.layoutCompoundLabel(tabPane, metrics, title, icon, SwingUtilities.TOP,		// vert
    ...
    protected void paintTabBackground(Graphics g, int tabPlacement, int tabIndex, int x, int y, int w, int h, boolean isSelected) {
        ...
        if (!(isSelected && ((tabPlacement == RIGHT) || (tabPlacement == LEFT) || (tabPlacement == BOTTOM)))) {
            ...
            if ((tabPlacement == TOP) || (tabPlacement == LEFT)) {
                ...
                top	= new Polygon(					// top left triangle
                    new int[] { x + 6, x + w, x + w, x, x }, new int[] { y, y, y + (h / 2), y + (h / 2), y + 6 }, 5);

            } else if (tabPlacement == RIGHT) {

                top	= new Polygon(		// top right triangle
                    new int[] { x, x + w - 6, x + w, x + w, x }, new int[] { y, y, y + 6, y + (h / 2), y + (h / 2) }, 5);
            }
        ...
        if (!(isSelected && ((tabPlacement == TOP) || (tabPlacement == RIGHT) || (tabPlacement == LEFT)))) {
            ...
            if (tabPlacement == BOTTOM) {
                    ...
                    new int[] { x, x + w, x + w, x + 6, x }, new int[] { y + (h / 2), y + (h / 2), y + h, y + h, y + h - 6 }, 5);
            }
...
/*
 * @(#)CompiereTabbedPaneUI.java   02.jul 2007
 * 
 *  Fin del fichero CompiereTabbedPaneUI.java
 *  
