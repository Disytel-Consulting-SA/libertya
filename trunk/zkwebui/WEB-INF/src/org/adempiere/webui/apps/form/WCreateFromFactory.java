...
import org.openXpertya.model.X_M_RMA;
...
public class WCreateFromFactory
{
	...
	static
	{
		...
		s_registeredClasses.put(X_C_Invoice.Table_ID, WCreateFromInvoiceUI.class);		
		s_registeredClasses.put(X_C_BankStatement.Table_ID, WCreateFromStatementUI.class);
		s_registeredClasses.put(X_M_InOut.Table_ID, WCreateFromShipmentUI.class);
		s_registeredClasses.put(X_M_RMA.Table_ID, WCreateFromRMAUI.class);
	}
