...
import org.openXpertya.model.MLot;
import org.openXpertya.model.MLotCtl;
import org.openXpertya.model.MQuery;
import org.openXpertya.model.MRole;
import org.openXpertya.model.MSerNoCtl;
import org.openXpertya.model.X_M_MovementLine;
...
//				false, true, 20, INSTANCE_VALUE_LENGTH, null, null);
	...
	private boolean cmd_select()
	{
		...
		if (m_AD_Column_ID == 8551) { // TODO: hardcoded: M_MovementLine[324].M_AttributeSetInstance_ID[8551]
			M_Locator_ID = Env.getContextAsInt(Env.getCtx(), m_WindowNoParent, "M_Locator_ID"/*, true*/); // only window
		}
