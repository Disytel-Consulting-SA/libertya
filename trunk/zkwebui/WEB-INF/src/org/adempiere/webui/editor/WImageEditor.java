...
public class WImageEditor extends WEditor
{
    ...
    public WImageEditor(MField gridField)
    {
    ...
    {
    	if (m_mImage == null || m_mImage.getID() == 0)
			return null;
	...
	public void onEvent(Event event) throws Exception 
	{
		if (Events.ON_CLICK.equals(event.getName()) && readwrite)
		{
			...
			if (!vid.isCancel()) {
				...
				//
				ValueChangeEvent vce = new ValueChangeEvent(this, mField.getColumnName(), oldValue, newValue);
				fireValueChange(vce);
			}
		}
	}
