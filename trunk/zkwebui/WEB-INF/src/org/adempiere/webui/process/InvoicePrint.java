...
public class InvoicePrint extends SvrProcess
{
	...
	protected String doIt() throws java.lang.Exception
	{
		...
		if (p_EMailPDF && p_R_MailText_ID == 0)
			//throw new AdempiereUserError ("@NotFound@: @R_MailText_ID@"); TODO Hernandez
		...
		if (p_R_MailText_ID != 0)
		{
			...
			if (mText.getID() != p_R_MailText_ID){}
				//throw new AdempiereUserError ("@NotFound@: @R_MailText_ID@ - " + p_R_MailText_ID); TODO Hernandez
		}
		...
		if (m_C_BPartner_ID == 0 && m_C_Invoice_ID == 0 && m_dateInvoiced_From == null && m_dateInvoiced_To == null
			...
			//throw new AdempiereUserError ("@RestrictSelection@") TODO Hernandez;
