...
/*
        ...
        private static AQQueue createQueue(String name)
        {
                ...
                try
                {
                        ...
                        t_property.setComment("OpenXpertya Client/Server Communication Table");
                        t_property.setSortOrder("ENQ_TIME");
                        t_property.setMultiConsumer(false);
                //      t_property.setCompatible("8.1");
                        //      Create table in the OpenXpertya scheme
                        ...
                        q_property.setComment("OpenXpertya Client/Server Communication Queue");
