...
public class PdfReader {
    ...
    private void readDecryptedDocObj() throws IOException {
        ...
        if (documentIDs != null) {
            ...
            s = o.toString();
            documentID = org.openXpertya.print.pdf.text.DocWriter.getISOBytes(s);
        }
        
        s = enc.get(PdfName.U).toString();
        byte uValue[] = org.openXpertya.print.pdf.text.DocWriter.getISOBytes(s);
        s = enc.get(PdfName.O).toString();
        byte oValue[] = org.openXpertya.print.pdf.text.DocWriter.getISOBytes(s);
