...
package org.openXpertya.print.pdf.text.html.simpleparser;
...
import org.openXpertya.print.pdf.text.DocListener;
...
import org.openXpertya.print.pdf.text.HeaderFooter;
...
import org.openXpertya.print.pdf.text.TextElementArray;
import org.openXpertya.print.pdf.text.Watermark;
import org.openXpertya.print.pdf.text.pdf.PdfPTable;
import org.openXpertya.print.pdf.text.pdf.SimpleXMLDocHandler;
import org.openXpertya.print.pdf.text.pdf.SimpleXMLParser;
...
public class HTMLWorker implements SimpleXMLDocHandler, DocListener {
    ...
    public void startElement(String tag, HashMap h) {
        ...
        if (tag.equals("ul")) {
            ...
            skipText = true;
            cprops.addToChain(tag, h);
            org.openXpertya.print.pdf.text.List list = new org.openXpertya.print.pdf.text.List(false, 10);
            list.setListSymbol("\u2022");
            stack.push(list);
            return;
        }
        if (tag.equals("ol")) {
            ...
            skipText = true;
            cprops.addToChain(tag, h);
            org.openXpertya.print.pdf.text.List list = new org.openXpertya.print.pdf.text.List(true, 10);
            stack.push(list);
            return;
        }
        if (tag.equals("li")) {
            ...
            pendingLI = true;
            cprops.addToChain(tag, h);
            stack.push(new org.openXpertya.print.pdf.text.ListItem());
            return;
        }
        ...
        try {
            ...
            if (tag.equals("ul") || tag.equals("ol")) {
                ...
                if (stack.empty())
                    return;
                Object obj = stack.pop();
                if (!(obj instanceof org.openXpertya.print.pdf.text.List)) {
                    stack.push(obj);
                    return;
                }
                if (stack.empty())
            ...
            if (tag.equals("li")) {
                ...
                if (!(list instanceof org.openXpertya.print.pdf.text.List)) {
                    stack.push(list);
                    return;
                }
                ListItem item = (ListItem)obj;
                ((org.openXpertya.print.pdf.text.List)list).add(item);
