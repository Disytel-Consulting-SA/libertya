    ...
    protected int goComposite(boolean simulate) throws DocumentException {
        ...
        while (true) {
            ...
            if (element.type() == Element.PARAGRAPH) {
                ...
                org.openXpertya.print.pdf.text.List list = (org.openXpertya.print.pdf.text.List)element;
                ...
                for (int k = 0; k < items.size(); ++k) {
                    ...
                    else if (obj instanceof org.openXpertya.print.pdf.text.List) {
                        stack.push(new Object[]{list, new Integer(k), new Float(listIndentation)});
                        list = (org.openXpertya.print.pdf.text.List)obj;
                        items = list.getItems();
                    ...
                    if (k == items.size() - 1) {
                        if (!stack.isEmpty()) {
                            ...
                            list = (org.openXpertya.print.pdf.text.List)objs[0];
                            items = list.getItems();
