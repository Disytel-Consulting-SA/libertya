...
public abstract class AbstractAmortizationProcessorFactory {
	 ...
	 * @return
	 */
	private static AbstractAmortizationProcessor getProcessor(Properties ctx, Class<?>[] constructorParamTypes, Object[] constructorParamArgs, String trxName){
	...
	public static AbstractAmortizationProcessor getProcessor(Properties ctx, MAmortization amortization, String trxName){
	...
	public static AbstractAmortizationProcessor getProcessor(Properties ctx, Integer amortizationID, String trxName){
		return getProcessor(ctx, new Class[] { Properties.class,
				Integer.class, String.class }, new Object[] { ctx,
				amortizationID, trxName }, trxName);
	}
	
	public static AbstractAmortizationProcessor getProcessor(Properties ctx, Timestamp date, String trxName){
		return getProcessor(ctx, new Class[] { Properties.class,
