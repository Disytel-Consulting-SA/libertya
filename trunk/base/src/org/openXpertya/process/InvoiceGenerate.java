...
public class InvoiceGenerate extends SvrProcess {
    ...
    protected void prepare() {
    	 log.info( "En IvoiceGenerate.prepare()" );
    	//JOptionPane.showMessageDialog( null,null,"En InvoiceGenerat, prepare()", JOptionPane.INFORMATION_MESSAGE );
        ProcessInfoParameter[] para = getParameter();

        for( int i = 0;i < para.length;i++ ) {
            String name = para[ i ].getParameterName();
           // JOptionPane.showMessageDialog( null,"En InvoiceGenerat, prepare() con el parametro= "+name,null, JOptionPane.INFORMATION_MESSAGE );
    ...
    protected String doIt() throws Exception {
    	//JOptionPane.showMessageDialog( null,null,"En InvoiceGenerat, doit(), con p_seleccion= "+p_Selection, JOptionPane.INFORMATION_MESSAGE );
    	log.info( "En IvoiceGenerate.doit()" );
        ...
        {
            sql = "SELECT * FROM C_Order " + "WHERE IsSelected='Y' AND (DocStatus='CO' OR DocStatus='CL') AND IsSOTrx='Y' " + "ORDER BY M_Warehouse_ID, PriorityRule, C_BPartner_ID, C_Order_ID";
        } else {
    ...
    private String generate( PreparedStatement pstmt ) {
    	//JOptionPane.showMessageDialog( null,null,"En InvoiceGenerat, generate()", JOptionPane.INFORMATION_MESSAGE );
    	log.info( "En IvoiceGenerate.generate()" );
        try {
    ...
    private void createLine( MOrder order,MOrderLine orderLine,BigDecimal qtyInvoiced,BigDecimal qtyEntered ) {
    	//JOptionPane.showMessageDialog( null,null,"En InvoiceGenerat, createline1()", JOptionPane.INFORMATION_MESSAGE );
    	log.info( "En IvoiceGenerate.createline1()" );
        if( m_invoice == null ) {
    ...
    private void createLine( MOrder order,MInOut ship,MInOutLine sLine ) {
    	//JOptionPane.showMessageDialog( null,null,"En InvoiceGenerat, createLine2()", JOptionPane.INFORMATION_MESSAGE );
    	log.info( "En IvoiceGenerate.createline2()" );
        if( m_invoice == null ) {
            m_invoice = new MInvoice( order,0,p_DateInvoiced );
    ...
    private void completeInvoice() {
    	//JOptionPane.showMessageDialog( null,null,"En InvoiceGenerat, completInvoice()", JOptionPane.INFORMATION_MESSAGE );
    	log.info( "En IvoiceGenerate.completImvoice()" );
        if( m_invoice != null ) {
...
/*
 *  @(#)InvoiceGenerate.java   02.07.07
 * 
 *  Fin del fichero InvoiceGenerate.java
 *  
 *  Versión 2.2
 *
 */
