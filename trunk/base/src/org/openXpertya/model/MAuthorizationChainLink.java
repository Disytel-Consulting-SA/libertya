...
public class MAuthorizationChainLink extends X_M_AuthorizationChainLink {
	...
	protected boolean beforeSave(boolean newRecord) {
		//Controlar que no existan rangos que se pisen con lo este eslabón
		if (DB.getSQLValue(
				this.get_TrxName(),
		...
		//Controlar que el monto máximo sea mayor al monto mínimo
		if (getMinimumAmount().compareTo(getMaximumAmount()) > 0){
