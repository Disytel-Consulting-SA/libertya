...
/** Modelo Generado por M_Warehouse_Close
 *  @author Comunidad de Desarrollo Libertya*         *Basado en Codigo Original Modificado, Revisado y Optimizado de:*         * Jorg Janke 
 *  @version  - 2010-02-19 19:10:00.022 */
public class X_M_Warehouse_Close extends org.openXpertya.model.PO
{
/** Constructor estándar */
public X_M_Warehouse_Close (Properties ctx, int M_Warehouse_Close_ID, String trxName)
{
super (ctx, M_Warehouse_Close_ID, trxName);
/** if (M_Warehouse_Close_ID == 0)
{
setDateTrx (new Timestamp(System.currentTimeMillis()));	// @#Date@
setDocAction (null);	// CO
setDocStatus (null);	// DR
setM_Warehouse_Close_ID (0);
setM_Warehouse_ID (0);
setProcessed (false);
}
 */
...
/** Load Constructor */
public X_M_Warehouse_Close (Properties ctx, ResultSet rs, String trxName)
{
super (ctx, rs, trxName);
}
/** AD_Table_ID */
public static final int Table_ID = M_Table.getTableID("M_Warehouse_Close");

/** TableName=M_Warehouse_Close */
public static final String Table_Name="M_Warehouse_Close";

protected static KeyNamePair Model = new KeyNamePair(Table_ID,"M_Warehouse_Close");
...
{
StringBuffer sb = new StringBuffer ("X_M_Warehouse_Close[").append(getID()).append("]");
return sb.toString();
}
...
/** Set M_Warehouse_Close_ID */
public void setM_Warehouse_Close_ID (int M_Warehouse_Close_ID)
{
set_ValueNoCheck ("M_Warehouse_Close_ID", new Integer(M_Warehouse_Close_ID));
}
/** Get M_Warehouse_Close_ID */
public int getM_Warehouse_Close_ID() 
{
Integer ii = (Integer)get_Value("M_Warehouse_Close_ID");
if (ii == null) return 0;
return ii.intValue();
}
/** Set Warehouse.
