...
/** Modelo Generado por MPC_Product_BOM
 *  @author Comunidad de Desarrollo openXpertya*         *Basado en Codigo Original Modificado, Revisado y Optimizado de:*         * Jorg Janke 
 *  @version  - 2008-01-03 10:26:36.328 */
public class X_MPC_Product_BOM extends PO
{
/** Constructor estándar */
public X_MPC_Product_BOM (Properties ctx, int MPC_Product_BOM_ID, String trxName)
{
...
/** AD_Table_ID=1000005 */
public static final int Table_ID=1000005;

/** TableName=MPC_Product_BOM */
public static final String Table_Name="MPC_Product_BOM";

protected static KeyNamePair Model = new KeyNamePair(1000005,"MPC_Product_BOM");
...
{
StringBuffer sb = new StringBuffer ("X_MPC_Product_BOM[").append(getID()).append("]");
return sb.toString();
}
