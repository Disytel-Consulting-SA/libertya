...
/** Modelo Generado por AD_Tab_Trl
 *  @author Comunidad de Desarrollo openXpertya*         *Basado en Codigo Original Modificado, Revisado y Optimizado de:*         * Jorg Janke 
 *  @version  - 2009-10-22 14:51:28.495 */
public class X_AD_Tab_Trl extends PO
{
/** Constructor estándar */
public X_AD_Tab_Trl (Properties ctx, int AD_Tab_Trl_ID, String trxName)
{
super (ctx, AD_Tab_Trl_ID, trxName);
/** if (AD_Tab_Trl_ID == 0)
{
setAD_Language (null);
setAD_Tab_ID (0);
...
/** Load Constructor */
public X_AD_Tab_Trl (Properties ctx, ResultSet rs, String trxName)
{
...
protected static KeyNamePair Model = new KeyNamePair(123,"AD_Tab_Trl");
...
{
StringBuffer sb = new StringBuffer ("X_AD_Tab_Trl[").append(getID()).append("]");
return sb.toString();
}
