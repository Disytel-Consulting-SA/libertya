...
/** Modelo Generado por C_CreditCard_Close
 *  @author Comunidad de Desarrollo Libertya*         *Basado en Codigo Original Modificado, Revisado y Optimizado de:*         * Jorg Janke 
 *  @version  - 2016-06-08 12:50:50.038 */
public class X_C_CreditCard_Close extends org.openXpertya.model.PO
{
/** Constructor estándar */
public X_C_CreditCard_Close (Properties ctx, int C_CreditCard_Close_ID, String trxName)
{
super (ctx, C_CreditCard_Close_ID, trxName);
/** if (C_CreditCard_Close_ID == 0)
{
setAllowReopening (false);	// N
setC_CreditCard_Close_ID (0);
...
/** Load Constructor */
public X_C_CreditCard_Close (Properties ctx, ResultSet rs, String trxName)
{
super (ctx, rs, trxName);
}
/** AD_Table_ID */
public static final int Table_ID = M_Table.getTableID("C_CreditCard_Close");

/** TableName=C_CreditCard_Close */
public static final String Table_Name="C_CreditCard_Close";

protected static KeyNamePair Model = new KeyNamePair(Table_ID,"C_CreditCard_Close");
...
{
StringBuffer sb = new StringBuffer ("X_C_CreditCard_Close[").append(getID()).append("]");
return sb.toString();
}
/** Set Allow Reopening */
public void setAllowReopening (boolean AllowReopening)
{
set_Value ("AllowReopening", new Boolean(AllowReopening));
}
/** Get Allow Reopening */
public boolean isAllowReopening() 
{
Object oo = get_Value("AllowReopening");
if (oo != null) 
{
...
{
set_ValueNoCheck ("C_CreditCard_Close_ID", new Integer(C_CreditCard_Close_ID));
}
...
{
return new KeyNamePair(getID(), String.valueOf(getC_CreditCard_Close_ID()));
}
...
/** Set Update Coupon Detail */
public void setUpdateCouponDetail (boolean UpdateCouponDetail)
{
set_Value ("UpdateCouponDetail", new Boolean(UpdateCouponDetail));
}
/** Get Update Coupon Detail */
public boolean isUpdateCouponDetail() 
{
Object oo = get_Value("UpdateCouponDetail");
if (oo != null) 
{
 if (oo instanceof Boolean) return ((Boolean)oo).booleanValue();
 return "Y".equals(oo);
