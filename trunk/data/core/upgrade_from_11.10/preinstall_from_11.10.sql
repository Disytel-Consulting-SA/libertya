...
DELETE FROM AD_Process_Access WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Access-1010250-0-20121031201757';
DELETE FROM AD_Process_Access WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Access-1010243-1010076-20121031201753';
DELETE FROM AD_TreeNodeMM WHERE ad_componentobjectuid = 'LIVA2CORE-AD_TreeNodeMM-1010115-1010385-20121031201751';
DELETE FROM AD_TreeNodeMM WHERE ad_componentobjectuid = 'LIVA2CORE-AD_TreeNodeMM-10-1010385-20121031201750';
DELETE FROM AD_Process_Access WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Access-1010243-0-20121031201748';
DELETE FROM AD_JasperReport WHERE ad_componentobjectuid = 'LIVA2CORE-AD_JasperReport-1010053-20121031201630';
DELETE FROM AD_Process_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Trl-es_PY-1010250-20121031201626';
DELETE FROM AD_Process_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Trl-es_MX-1010250-20121031201624';
DELETE FROM AD_Process_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Trl-es_AR-1010250-20121031201622';
DELETE FROM AD_Process_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Trl-es_ES-1010250-20121031201620';
DELETE FROM AD_Process WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process-1010250-20121031201617';
DELETE FROM AD_Field_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Field_Trl-1016464-es_MX-20121031201610';
DELETE FROM AD_Field_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Field_Trl-1016464-es_AR-20121031201608';
DELETE FROM AD_Field_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Field_Trl-1016464-es_ES-20121031201606';
DELETE FROM AD_Field WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Field-1016464-20121031201603';
DELETE FROM AD_Column_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Column_Trl-1015147-es_MX-20121031201601';
DELETE FROM AD_Column_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Column_Trl-1015147-es_AR-20121031201559';
DELETE FROM AD_Column_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Column_Trl-1015147-es_ES-20121031201557';
DELETE FROM AD_Column WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Column-1015147-20121031201553';
DELETE FROM AD_Element_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Element_Trl-1011058-es_MX-20121031201551';
DELETE FROM AD_Element_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Element_Trl-1011058-es_AR-20121031201549';
DELETE FROM AD_Element_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Element_Trl-1011058-es_ES-20121031201546';
DELETE FROM AD_Element WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Element-1011058-20121031201545';
DELETE FROM AD_Field_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Field_Trl-1016463-es_MX-20121031201534';
DELETE FROM AD_Field_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Field_Trl-1016463-es_AR-20121031201532';
DELETE FROM AD_Field_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Field_Trl-1016463-es_ES-20121031201530';
DELETE FROM AD_Field WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Field-1016463-20121031201527';
DELETE FROM AD_Column_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Column_Trl-1015146-es_MX-20121031201524';
DELETE FROM AD_Column_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Column_Trl-1015146-es_AR-20121031201522';
DELETE FROM AD_Column_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Column_Trl-1015146-es_ES-20121031201520';
DELETE FROM AD_Column WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Column-1015146-20121031201516';
DELETE FROM AD_Menu_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Menu_Trl-es_MX-1010385-20121031201514';
DELETE FROM AD_Menu_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Menu_Trl-es_AR-1010385-20121031201512';
DELETE FROM AD_Menu_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Menu_Trl-es_ES-1010385-20121031201510';
DELETE FROM AD_Menu WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Menu-1010385-20121031201507';
DELETE FROM AD_Process_Para_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Para_Trl-es_MX-1010495-20121031201505';
DELETE FROM AD_Process_Para_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Para_Trl-es_AR-1010495-20121031201503';
DELETE FROM AD_Process_Para_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Para_Trl-es_ES-1010495-20121031201501';
DELETE FROM AD_Process_Para WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Para-1010495-20121031201458';
DELETE FROM AD_Process_Para_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Para_Trl-es_MX-1010494-20121031201456';
DELETE FROM AD_Process_Para_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Para_Trl-es_AR-1010494-20121031201454';
DELETE FROM AD_Process_Para_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Para_Trl-es_ES-1010494-20121031201452';
DELETE FROM AD_Process_Para WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Para-1010494-20121031201449';
DELETE FROM AD_Process_Para_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Para_Trl-es_MX-1010493-20121031201447';
DELETE FROM AD_Process_Para_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Para_Trl-es_AR-1010493-20121031201444';
DELETE FROM AD_Process_Para_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Para_Trl-es_ES-1010493-20121031201442';
DELETE FROM AD_Process_Para WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Para-1010493-20121031201439';
DELETE FROM AD_Process_Para_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Para_Trl-es_MX-1010492-20121031201437';
DELETE FROM AD_Process_Para_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Para_Trl-es_AR-1010492-20121031201434';
DELETE FROM AD_Process_Para_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Para_Trl-es_ES-1010492-20121031201433';
DELETE FROM AD_Process_Para WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Para-1010492-20121031201429';
DELETE FROM AD_Process_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Trl-es_MX-1010243-20121031201427';
DELETE FROM AD_Process_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Trl-es_AR-1010243-20121031201426';
DELETE FROM AD_Process_Trl WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process_Trl-es_ES-1010243-20121031201423';
DELETE FROM AD_Process WHERE ad_componentobjectuid = 'LIVA2CORE-AD_Process-1010243-20121031201420';
DELETE FROM AD_JasperReport WHERE ad_componentobjectuid = 'LIVA2CORE-AD_JasperReport-1010047-20121031201418';
