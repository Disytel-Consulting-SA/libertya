...
#CERT = "hiperg_17abe98f029c75bf.crt"        # El certificado X.509 obtenido de Seg. Inf.
CERT = ""
#PRIVATEKEY = "tehuelche.key"  # La clave privada del certificado CERT
PRIVATEKEY = ""
...
#        cacert = len(argv)>7 and argv[7] or CACERT
        ...
        print "wsaa.Version", wsaa.Version
