...
/** Modelo Generado por AD_Field_Trl
 *  @author Comunidad de Desarrollo openXpertya*         *Basado en Codigo Original Modificado, Revisado y Optimizado de:*         * Jorg Janke 
 *  @version  - 2009-10-22 14:51:26.584 */
public class X_AD_Field_Trl extends PO
{
/** Constructor estándar */
public X_AD_Field_Trl (Properties ctx, int AD_Field_Trl_ID, String trxName)
{
super (ctx, AD_Field_Trl_ID, trxName);
...
/** Load Constructor */
public X_AD_Field_Trl (Properties ctx, ResultSet rs, String trxName)
{
...
{
StringBuffer sb = new StringBuffer ("X_AD_Field_Trl[").append(getID()).append("]");
return sb.toString();
}
