/*
 * $Id: GUIInstaller.java 1747 2007-02-18 18:23:57Z vralev $
...
public class GUIInstaller extends InstallerBase
{
    ...
    private void checkJavaVersion() throws Exception
    {
        ...
        if (version.compareTo(required) < 0)
        {
            ...
            msg.append("La aplicacion que esta intentando instalar requiere una version de la Plataforma Java mayor o igual que ");
            msg.append(required);
            msg.append("Usted tiene instalada la version  ");
            msg.append(version);
            msg.append("Por favor, actualizela a la nueva version.");
    ...
    private void loadLangPack() throws Exception
    {
        ...
        if (npacks == 0) throw new Exception("El idioma elegido no esta disponible en este momento");
        String selectedPack;
        ...
        if (npacks != 1)
        {
            ...
            if (selectedPack == null) throw new Exception("Instalacion Cancelada");
        }
        else
    ...
    private final class LanguageDialog extends JDialog implements ActionListener
    {
        ...
        public LanguageDialog(JFrame frame, Object[] items)
        {
            ...
            String firstMessage = "Por Favor, seleccione su idioma";
            if (getLangType().equals(LANGUAGE_DISPLAY_TYPES[0]))
            // iso3
                firstMessage = "Por favor, seleccione su idioma (Codificado ISO3)";
            ...
            JLabel label2 = new JLabel("para la instalacion:", SwingConstants.CENTER);
