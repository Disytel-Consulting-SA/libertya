...
public class Unix_Shortcut extends Shortcut implements Unix_ShortcutConstants
{
    ...
    // *******************************************************************************************************************************
    /** version = "$Id: Unix_Shortcut.java 1741 2007-02-17 13:38:23Z jponge $" */
    private static String version = "$Id: Unix_Shortcut.java 1741 2007-02-17 13:38:23Z jponge $";

    /** rev = "$Revision: 1741 $" */
    private static String rev = "$Revision: 1741 $";
