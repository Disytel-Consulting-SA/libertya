...
public class WLocatorEditor extends WEditor implements EventListener, PropertyChangeListener, ContextMenuListener, IZoomableEditor
{
	...
	{
		int AD_Window_ID = M_Table.get(Env.getCtx(), MLocator.Table_ID).getAD_Window_ID();
		if (AD_Window_ID <= 0)
		...
		zoomQuery.addRestriction("M_Locator_ID", MQuery.EQUAL, getValue());
	...
	private void setDefault_Locator_ID()
	{
		...
		setValue(Integer.valueOf(loc.getID()));
	}
