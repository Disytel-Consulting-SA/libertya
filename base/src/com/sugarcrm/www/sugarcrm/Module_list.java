...
public class Module_list  implements java.io.Serializable {
    private com.sugarcrm.www.sugarcrm.Module_list_entry[] modules;

    public Module_list() {
    }

    public Module_list(
           com.sugarcrm.www.sugarcrm.Module_list_entry[] modules) {
     ...
     * @return modules
     */
    public com.sugarcrm.www.sugarcrm.Module_list_entry[] getModules() {
        return modules;
    }
     ...
     * @param modules
     */
    public void setModules(com.sugarcrm.www.sugarcrm.Module_list_entry[] modules) {
        this.modules = modules;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.sugarcrm.com/sugarcrm", "module_list_entry"));
