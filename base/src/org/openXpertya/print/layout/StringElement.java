...
public class StringElement extends PrintElement {
    ...
    public StringElement( Object content,Font font,Paint paint,NamePair ID,String label,String labelSuffix ) {
        super();
        log.finest( "Label=" + label + "|" + labelSuffix + ", Content=" + content + ", ID=" + ID );
        m_font  = font;
        m_paint = paint;
    ...
    public void paint( Graphics2D g2D,int pageNo,Point2D pageStart,Properties ctx,boolean isView ) {
        ...
        if( m_check != null ) {
            ...
            g2D.drawImage( m_check.booleanValue()
                           ?LayoutEngine.IMAGE_TRUE
                           :LayoutEngine.IMAGE_FALSE,x,y,this );
        }
    }    // paint
...
/*
 *  @(#)StringElement.java   12.10.07
 * 
 *  Fin del fichero StringElement.java
 *  
 *  Versión 2.2
 *
 */
