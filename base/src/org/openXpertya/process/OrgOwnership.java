...
public class OrgOwnership extends SvrProcess {
    ...
    private String productOwnership() {
        ...
        if( p_M_Product_Category_ID > 0 ) {
            set += " WHERE EXISTS (SELECT * FROM M_Product p" + " WHERE p.M_Product_ID=x.M_Product_ID AND p.M_Product_Category_ID=" + p_M_Product_Category_ID + ")";
        } else {
...
/*
 *  @(#)OrgOwnership.java   02.07.07
 * 
 *  Fin del fichero OrgOwnership.java
 *  
 *  Versión 2.2
 *
 */
