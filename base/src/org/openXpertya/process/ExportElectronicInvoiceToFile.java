...
public class ExportElectronicInvoiceToFile extends SvrProcess {
	...
	protected String doIt() throws Exception {
		...
		sql.append("select " +
				...
				" (select sum(grandtotal) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as factgrandtotal, "+
				" (select sum(grandtotal) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and issotrx = 'Y' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as ventagrandtotal, "+
				" (select sum(grandtotal) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and issotrx = 'N' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as compragrandtotal, "+
				// Importe total de conceptos que no integran el precio neto gravado
				" (select sum(taxbaseamt) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as facttaxbaseamt, "+
				" (select sum(taxbaseamt) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and issotrx = 'Y' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as ventataxbaseamt, "+
				" (select sum(taxbaseamt) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and issotrx = 'N' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as comprataxbaseamt, "+
				// Importe neto gravado
				" (select sum(totallines) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as facttotallines, "+
				" (select sum(totallines) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and issotrx = 'Y' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as ventatotallines, "+
				" (select sum(totallines) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and issotrx = 'N' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as compratotallines, "+
				// Impuesto liquidado
				" (select sum(taxamt) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as facttaxamt, "+
				" (select sum(taxamt) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and issotrx = 'Y' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as ventataxamt, "+
				" (select sum(taxamt) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and issotrx = 'N' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as comprataxamt, "+
				" (select sum(rni) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as factrni, "+
				" (select sum(rni) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and issotrx = 'Y' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as ventarni, "+
				" (select sum(rni) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and issotrx = 'N' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as comprarni, "+
				" (select sum(operacionesexentas) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as factoperacionesexentas, "+
				" (select sum(operacionesexentas) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and issotrx = 'Y' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as ventaoperacionesexentas, "+
				" (select sum(operacionesexentas) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and issotrx = 'N' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as compraoperacionesexentas, "+
				" (select sum(importepercepciones) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as factimportepercepciones, "+
				" (select sum(importepercepciones) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and issotrx = 'Y' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as ventaimportepercepciones, "+
				" (select sum(importepercepciones) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and issotrx = 'N' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as compraimportepercepciones, "+
				" (select sum(percepcionesiibb) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as factpercepcionesiibb, "+
				" (select sum(percepcionesiibb) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and issotrx = 'Y' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as ventapercepcionesiibb, "+
				" (select sum(percepcionesiibb) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and issotrx = 'N' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as comprapercepcionesiibb, "+
				" (select sum(impuestosmunicipales) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as factimpuestosmunicipales, "+
				" (select sum(impuestosmunicipales) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and issotrx = 'Y' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as ventaimpuestosmunicipales, "+
				" (select sum(impuestosmunicipales) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and issotrx = 'N' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as compraimpuestosmunicipales, "+
				" (select sum(impuestosinternos) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as factimpuestosinternos, "+
				" (select sum(impuestosinternos) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and issotrx = 'Y' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as ventaimpuestosinternos, "+
				" (select sum(impuestosinternos) from e_electronicinvoice where dateinvoiced >= '"+periodo.getStartDate()+"' and date_trunc('day',dateinvoiced) <= '"+periodo.getEndDate()+"' and issotrx = 'N' and (AD_Client_ID = "+ getAD_Client_ID() +") and (createdby = "+ getAD_User_ID()+")) as compraimpuestosinternos, "+
