...
import org.openXpertya.model.X_AD_UnattendedUpgrade;
...
public class UnattendedUpgradeScheduleAllHostsProcess extends SvrProcess {
	...
	protected String doIt() throws Exception {
		...
		PreparedStatement pstmt = DB.prepareStatement("SELECT AD_Client_ID, AD_Org_ID FROM AD_ReplicationHost WHERE isActive = 'Y'", get_TrxName());
		...
		while (rs.next()) {
			...
			unUpHost.setClientOrg(rs.getInt("AD_Client_ID"), rs.getInt("AD_Org_ID"));
