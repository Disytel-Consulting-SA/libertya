...
public class MLandedCost extends X_C_LandedCost {
    ...
    protected boolean beforeSave( boolean newRecord ) {
        ...
        if( (getM_Product_ID() == 0) && (getM_InOut_ID() == 0) && (getM_InOutLine_ID() == 0) ) {
            log.saveError( "Error",Msg.parseTranslation( getCtx(),"@NotFound@ @M_Product_ID@ | @M_InOut_ID@ | @M_InOutLine_ID@" ));
...
/*
 *  @(#)MLandedCost.java   02.07.07
 * 
 *  Fin del fichero MLandedCost.java
 *  
 *  Versión 2.2
 *
 */
