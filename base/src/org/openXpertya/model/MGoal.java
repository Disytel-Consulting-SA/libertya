	...
	public static MGoal[] getUserGoals(Properties ctx, int AD_User_ID)
	{
		...
		try
		{
			...
			while (rs.next ())
			{
				...
				//TODO Hernandez goal.updateGoal(false);
				list.add (goal);
			}
		}
		catch (Exception e)
