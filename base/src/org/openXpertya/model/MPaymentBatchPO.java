...
//				}
				...
				//Generar y completar el payment 
				...
				pay.setMicr(bankAccount.getSucursal() + ";" + bankAccount.getAccountNo() + ";" + pay.getCheckNo()); // Sucursal
				
				if (!detail.getBatch_Payment_Rule()
						.equals(X_C_PaymentBatchPODetail.BATCH_PAYMENT_RULE_ElectronicTransfer)) {
				...
				//Actualizo el siguiente número de la chequera
				if(chequera != null){
