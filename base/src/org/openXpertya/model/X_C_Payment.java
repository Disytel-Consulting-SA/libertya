...
public static final int C_INVOICE_CHECK_REJECTED_ID_AD_Reference_ID = MReference.getReferenceID("C_Invoice");
/** Set Rejected Check Invoice.
Invoice generated by Check Rejection Process */
public void setC_Invoice_Check_Rejected_ID (int C_Invoice_Check_Rejected_ID)
{
if (C_Invoice_Check_Rejected_ID <= 0) set_Value ("C_Invoice_Check_Rejected_ID", null);
 else 
set_Value ("C_Invoice_Check_Rejected_ID", new Integer(C_Invoice_Check_Rejected_ID));
}
/** Get Rejected Check Invoice.
Invoice generated by Check Rejection Process */
public int getC_Invoice_Check_Rejected_ID() 
{
Integer ii = (Integer)get_Value("C_Invoice_Check_Rejected_ID");
if (ii == null) return 0;
return ii.intValue();
}
/** Set Invoice.
