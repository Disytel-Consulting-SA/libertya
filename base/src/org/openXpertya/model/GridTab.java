...
public class GridTab implements DataStatusListener, Evaluatee, Serializable
{
	...
	private void loadDependentInfo()
	{
		...
		{
			Integer location_int = (Integer) getValue("C_Location_ID");
			...
			GridField fPhone = getField("Phone");
			M_Column colPhone = null;
			if (fPhone != null)
				colPhone = M_Column.get(Env.getCtx(), fPhone.getAD_Column_ID());
			GridField fPhone2 = getField("Phone2");
			M_Column colPhone2 = null;
			if (fPhone2 != null)
				colPhone2 = M_Column.get(Env.getCtx(), fPhone2.getAD_Column_ID());
			GridField fFax = getField("Fax");
			M_Column colFax = null;
			if (fFax != null)
				colFax = M_Column.get(Env.getCtx(), fFax.getAD_Column_ID());
