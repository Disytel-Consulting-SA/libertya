...
public class VOrdenCobro extends VOrdenPago {
	...
	protected void initTranslations() {
		...
		lblBPartnerDiscount.setText(Msg.translate(m_ctx, "M_DiscountSchema_ID"));
	...
	protected void addCustomPaymentTabs(JTabbedPane tabbedPane) {
		...
		tabbedPane.addTab(Msg.translate(m_ctx, "C_Withholding_ID"), createRetencionTab());
		...
		tabbedPane.addTab(Msg.translate(m_ctx, "CreditCard"), createCreditCardTab());
	...
	protected void addCustomOperationAfterTabsDefinition(){
		...
		// tender type actual 
		processPaymentTabs(jTabbedPane2,
            ...
            .add(jPanel3Layout.createSequentialGroup()
                ...
                .add(jPanel3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel3Layout.createSequentialGroup()
                        ...
                        .add(lblOrgCharge)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(txtOrgCharge, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 95, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(lblTotalPagar1)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .add(jPanel5Layout.createSequentialGroup()
                ...
                .add(jPanel5Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(cboCashReceiptMedium, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 193, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel5Layout.setVerticalGroup(
            ...
            .add(jPanel5Layout.createSequentialGroup()
                ...
                .add(jPanel5Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblCashReceiptMedium)
                    .add(cboCashReceiptMedium, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel5Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblEfectivoLibroCaja)
	...
	protected JComponent createTransferTab(){
		...
		cboTransferReceiptMedium.addItemListener(getPaymentMediumItemListener());
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .add(jPanel6Layout.createSequentialGroup()
                ...
                .add(jPanel6Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(cboTransferReceiptMedium, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel6Layout.setVerticalGroup(
            ...
            .add(jPanel6Layout.createSequentialGroup()
                ...
                .add(jPanel6Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblTransferReceiptMedium)
                    .add(cboTransferReceiptMedium, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel6Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblTransfCtaBancaria)
	...
	protected JComponent createCheckTab(){
        ...
        chequeFechaEmision.addVetoableChangeListener(new VetoableChangeListener() {
			
			@Override
			public void vetoableChange(PropertyChangeEvent arg0)
					throws PropertyVetoException {
				if(cboCheckReceiptMedium.getSelectedItem() != null){
					updateFechaPagoCheque((MPOSPaymentMedium)cboCheckReceiptMedium.getSelectedItem());
				}
			}
		});
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .add(jPanel7Layout.createSequentialGroup()
                ...
                .add(jPanel7Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(cboCheckReceiptMedium, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 165, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel7Layout.setVerticalGroup(
            ...
            .add(jPanel7Layout.createSequentialGroup()
                ...
                .add(jPanel7Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblCheckReceiptMedium)
                    .add(cboCheckReceiptMedium, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel7Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblChequeChequera)
        ...
        jPanel11Layout.setHorizontalGroup(
            ...
            .add(jPanel11Layout.createSequentialGroup()
                ...
                .add(jPanel11Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(cboCreditReceiptMedium, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel11Layout.setVerticalGroup(
            ...
            .add(jPanel11Layout.createSequentialGroup()
                ...
                .add(jPanel11Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblCreditReceiptMedium)
                    .add(cboCreditReceiptMedium, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel11Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblCreditInvoice)
	...
	private JComponent createRetencionTab() {
        ...
        retencSchema = VComponentsFactory.VLookupFactory("C_RetencionSchema_ID", "C_RetencionSchema", m_WindowNo, DisplayType.Search, getCobroModel().getRetencionSqlValidation());
        ...
        cboRetencionReceiptMedium.addItemListener(getPaymentMediumItemListener());
        
        org.jdesktop.layout.GroupLayout jPanel6Layout = new org.jdesktop.layout.GroupLayout(panelRetenc);
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .add(jPanel6Layout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel6Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(txtRetencImporte, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
                    .add(txtRetencNroRetenc, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
                    .add(retencSchema, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
                    .add(retencFecha, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
                    .add(cboRetencionReceiptMedium, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel6Layout.setVerticalGroup(
            jPanel6Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(jPanel6Layout.createSequentialGroup()
                ...
                .add(jPanel6Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblRetencionReceiptMedium)
                    .add(cboRetencionReceiptMedium, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel6Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblRetencSchema)
                    .add(retencSchema, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel6Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblRetencNroRetenc)
                    .add(txtRetencNroRetenc, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel6Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblRetencImporte)
                    .add(txtRetencImporte, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel6Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblRetencFecha)
                    .add(retencFecha, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(66, Short.MAX_VALUE))
        );
	...
	protected JComponent createCreditCardTab(){
	    ...
	    txtCreditCardAmt.addVetoableChangeListener(new VetoableChangeListener() {
		...
		cboCreditCardReceiptMedium .addItemListener(getPaymentMediumItemListener());
		...
		org.jdesktop.layout.GroupLayout jPanelCreditCardLayout = new org.jdesktop.layout.GroupLayout(panelCreditCard);
		panelCreditCard.setLayout(jPanelCreditCardLayout);
        jPanelCreditCardLayout.setHorizontalGroup(
        		jPanelCreditCardLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        			.add(jPanelCreditCardLayout.createSequentialGroup()
        					.addContainerGap()
        					.add(jPanelCreditCardLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
        							...
        							.add(lblCuotaAmt))
        					.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        					.add(jPanelCreditCardLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				                    .add(cboCreditCardReceiptMedium, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
				                    .add(cboEntidadFinancieraPlans, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
				                    .add(cboCreditCardBank, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
				                    .add(txtCreditCardNo, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
				                    .add(txtCreditCardCouponNo, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
				                    .add(txtCreditCardAmt, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
				                    .add(txtCuotasCount, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
				                    .add(txtCuotaAmt, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE))
			                .addContainerGap())
        );
        jPanelCreditCardLayout.setVerticalGroup(
            ...
            .add(jPanelCreditCardLayout.createSequentialGroup()
                .addContainerGap()
                .add(jPanelCreditCardLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblCreditCardReceiptMedium)
                    .add(cboCreditCardReceiptMedium, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanelCreditCardLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblCreditCardPlan)
                    .add(cboEntidadFinancieraPlans, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanelCreditCardLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblCreditCardBank)
                    .add(cboCreditCardBank, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanelCreditCardLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblCreditCardNo)
                    .add(txtCreditCardNo, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanelCreditCardLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblCreditCardCouponNo)
                    .add(txtCreditCardCouponNo, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanelCreditCardLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblCreditCardAmt)
                    .add(txtCreditCardAmt, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanelCreditCardLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblCuotasCount)
                    .add(txtCuotasCount, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanelCreditCardLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblCuotaAmt)
                    .add(txtCuotaAmt, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(66, Short.MAX_VALUE))
        );
	...
	protected JComponent createPagoAdelantadoTab(){
        ...
        cboPagoAdelantadoReceiptMedium.addItemListener(getPaymentMediumItemListener());
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .add(jPanel7Layout.createSequentialGroup()
                ...
                .add(jPanel7Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(cboPagoAdelantadoReceiptMedium, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 165, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel7Layout.setVerticalGroup(
            jPanel7Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(jPanel7Layout.createSequentialGroup()
                ...
                .add(jPanel7Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblPagoAdelantadoReceiptMedium)
                    .add(cboPagoAdelantadoReceiptMedium, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel7Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblPagoAdelantadoType)
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .add(jPanel4Layout.createSequentialGroup()
                ...
                .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(panelTenderType, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .add(panelPaymentDiscount, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
//                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED, 10, 10)
                .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jPanel4Layout.createSequentialGroup()
                            	.add(cmdGrabar)
                            	.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
    ...
    protected void createTenderTypePanel(){
		...
		cboTenderType.addItemListener(new ItemListener() {
			...
			public void itemStateChanged(ItemEvent arg0) {
		    	...
		    	MPOSPaymentMedium selectedPaymentMedium = (MPOSPaymentMedium) tenderTypeIndexsCombos.get(
						jTabbedPane2.getSelectedIndex()).getSelectedItem();
...
//		cboTenderType.setSelectedItem(MPOSPaymentMedium.TENDERTYPE_Cash);
		// Layout del panel
		org.jdesktop.layout.GroupLayout jPanel7Layout = new org.jdesktop.layout.GroupLayout(panelTenderType);
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .add(jPanel7Layout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel7Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(cboTenderType, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)))
        );
        jPanel7Layout.setVerticalGroup(
            jPanel7Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(jPanel7Layout.createSequentialGroup()
    ...
    protected void createDocumentDiscountComponents(){
    	lblDiscountAmt = new javax.swing.JLabel(Msg.translate(m_ctx,"DiscountCharge"));
    ...
    protected void createPaymentMediumDiscountPanel(){
		...
		lblPaymentDiscount = new javax.swing.JLabel(Msg.translate(m_ctx,"DiscountCharge"));
		lblPaymentToPayDiscount = new javax.swing.JLabel(Msg.translate(m_ctx,"DiscountedChargedToPayAmt"));
    	...
    	org.jdesktop.layout.GroupLayout jPanel8Layout = new org.jdesktop.layout.GroupLayout(panelPaymentDiscount);
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .add(jPanel8Layout.createSequentialGroup()
                ...
                .add(jPanel8Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(txtPaymentDiscount, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
                    .add(txtPaymentToPayDiscount, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel8Layout.setVerticalGroup(
            ...
            .add(jPanel8Layout.createSequentialGroup()
                ...
                .add(jPanel8Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblPaymentDiscount)
                    .add(txtPaymentDiscount, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel8Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblPaymentToPayDiscount)
                    .add(txtPaymentToPayDiscount, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
    }
...
//    	panelSummary.setBorder(BorderFactory.createEtchedBorder());
    	...
    	org.jdesktop.layout.GroupLayout jPanel9Layout = new org.jdesktop.layout.GroupLayout(panelSummary);
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .add(jPanel9Layout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel9Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(txtMedioPago2, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
                    .add(txtRetenciones2, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE))
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel9Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(txtDiscountAmt, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
                    .add(txtSaldo, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel9Layout.setVerticalGroup(
            jPanel9Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(jPanel9Layout.createSequentialGroup()
                ...
                .add(jPanel9Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    ...
                    .add(lblDiscountAmt)
                    .add(txtDiscountAmt, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel9Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblRetenciones2)
	...
	protected CComboBox createTenderTypeCombo() {
		...
		List<ValueNamePair> list = MPOSPaymentMedium
				.getTenderTypesByContextOfUse(Env.getCtx(),
						MPOSPaymentMedium.CONTEXT_POSOnly, true,
						true, null);
	...
	protected void initializeTenderTypeTabsRelations(){
		...
		tenderTypesTabRelations.put(MPOSPaymentMedium.TENDERTYPE_Cash, Arrays
				.asList(TAB_INDEX_EFECTIVO));
		tenderTypesTabRelations.put(MPOSPaymentMedium.TENDERTYPE_Check, Arrays
				.asList(TAB_INDEX_CHEQUE));
		...
		tenderTypesTabRelations.put(MPOSPaymentMedium.TENDERTYPE_AdvanceReceipt,
	...
	protected void processPaymentTabs(JTabbedPane tabbedPane, String tenderType){
		...
		if(tenderType != null){
			// Obtengo la lista de índices de pestañas relacionadas con el tipo de
			// pago parámetro
	 ...
	 */
	protected void saveBasicValidation(MPOSPaymentMedium paymentMedium, MEntidadFinancieraPlan plan) throws Exception{
	...
	protected void cmdCustomSaveMedioPago(int tabIndex) throws Exception {
		...
		else super.cmdCustomSaveMedioPago(tabIndex);
	}
	
	private void saveRetencionMedioPago() throws Exception {
		// Obtengo los datos de la interfaz
		MPOSPaymentMedium paymentMedium = (MPOSPaymentMedium)cboRetencionReceiptMedium.getSelectedItem();
	...
	protected void saveCreditCardMedioPago() throws Exception{
		...
		MPOSPaymentMedium paymentMedium = (MPOSPaymentMedium)cboCreditCardReceiptMedium.getSelectedItem();
		MEntidadFinancieraPlan plan = (MEntidadFinancieraPlan)cboEntidadFinancieraPlans.getSelectedItem();
		saveBasicValidation(paymentMedium, plan);
		getCobroModel().addCreditCard(paymentMedium, plan,
				txtCreditCardNo.getText(), txtCreditCardCouponNo.getText(),
	...
	protected MedioPagoCheque saveCheckMedioPago() throws Exception{
		// Obtengo la data de la interfaz gráfica
		MPOSPaymentMedium paymentMedium = (MPOSPaymentMedium)cboCheckReceiptMedium.getSelectedItem();
		saveBasicValidation(paymentMedium, null);
		BigDecimal amount = null;
		try {
...
//		toPayValidation();
		MPOSPaymentMedium paymentMedium = (MPOSPaymentMedium)cboCashReceiptMedium.getSelectedItem();
		saveBasicValidation(paymentMedium, null);
	...
	protected MedioPagoTransferencia saveTransferMedioPago() throws Exception{
		...
		MPOSPaymentMedium paymentMedium = (MPOSPaymentMedium)cboTransferReceiptMedium.getSelectedItem();
		saveBasicValidation(paymentMedium, null);
	...
	protected MedioPagoCredito saveCreditMedioPago() throws Exception{
		...
		MPOSPaymentMedium paymentMedium = (MPOSPaymentMedium)cboCreditReceiptMedium.getSelectedItem();
		saveBasicValidation(paymentMedium, null);
	...
	protected MedioPago savePagoAdelantadoMedioPago() throws Exception {
		...
		MPOSPaymentMedium paymentMedium = (MPOSPaymentMedium)cboPagoAdelantadoReceiptMedium.getSelectedItem();
		saveBasicValidation(paymentMedium, null);
	...
	private void loadRetencion(RetencionProcessor retencion) {
		retencSchema.setValue(retencion.getRetencionSchema().getC_RetencionSchema_ID());
		txtRetencNroRetenc.setText(retencion.getRetencionNumber());
		txtRetencImporte.setText(getModel().numberFormat(retencion.getAmount()));
	...
	protected void loadMedioPago(VOrdenPagoModel.MedioPago mp) {
		if(mp.getTipoMP().equals(MedioPago.TIPOMEDIOPAGO_TARJETACREDITO)){
			...
			cboCreditCardReceiptMedium.setSelectedItem(tarjeta.getPaymentMedium());
			cboEntidadFinancieraPlans.setSelectedItem(tarjeta.getEntidadFinancieraPlan());
			...
			txtCuotasCount.setText(""+tarjeta.getEntidadFinancieraPlan().getCuotasPago());
			txtCuotaAmt.setValue(tarjeta.getCuotaAmt());
			cboCreditCardBank.setValue(tarjeta.getBank());
		}
		else {
			super.loadMedioPago(mp);
			CComboBox comboReceiptMedium = tenderTypeIndexsCombos.get(jTabbedPane2.getSelectedIndex());
	...
	protected CComboBox createPaymentMediumCombo(String tenderType){
		...
		List<MPOSPaymentMedium> mediums = getCobroModel().getPaymentMediums(tenderType);
	 ...
	 * 
	 * @param paymentMedium medio de pago
	 */
    private void refreshPaymentMediumAmountInfo(MPOSPaymentMedium paymentMedium) {
		...
		txtPaymentToPayDiscount.setValue(paymentToPayAmt.compareTo(BigDecimal.ZERO) > 0 
							? paymentToPayAmt
							: null);
		...
		if (paymentMedium != null
			...
			if(plan != null){
				BigDecimal amt = txtCreditCardAmt.getValue() == null ? BigDecimal.ZERO
						: (BigDecimal) txtCreditCardAmt.getValue();
				BigDecimal cuotaAmt = amt.divide(new BigDecimal(plan
						.getCuotasPago()), 10, BigDecimal.ROUND_HALF_UP);
    ...
    /**
     * @return El plan seleccionado en el ComboBox
     * (solo para medios de pago de tipo tarjeta)
     */
    protected MEntidadFinancieraPlan getSelectedPlan() {
    	return (MEntidadFinancieraPlan)cboEntidadFinancieraPlans.getSelectedItem();
    }
    ...
    protected void loadCheckInfo(MPOSPaymentMedium paymentMedium){
    	if(!Util.isEmpty(paymentMedium.getBank())){
    		txtChequeBanco.setText(getCobroModel().getBankName(paymentMedium.getBank()));
...
//			}
    ...
    /**
     * Actualizo la fecha de pago del cheque a partir de lo que contiene la fecha de emisión
     * @param paymentMedium
     */
    ...
    protected void removeTenderTypesValuesByCustomConditions(){
    	...
    	for (int i = 0; i < itemsCount; i++) {
			...
			if (!getModel().isNormalPayment() && (value.getValue().equals(MPOSPaymentMedium.TENDERTYPE_Credit)
    ...
    protected void updateDiscount(MPOSPaymentMedium paymentMedium){
		...
		getCobroModel().updateGeneralDiscount(isApplicable?discountSchema:null);
		// Componente de esquema de descuento actual de medio de pago
		txtPaymentDiscount.setText(isApplicable?discountSchema.toString():null);
    ...
    protected MDiscountSchema getSelectedPaymentMediumDiscountSchema(MPOSPaymentMedium paymentMedium){
    ...
    protected void updateGroupingAmtInvoices(boolean untilActualDueDate){
		if (radPayTypeStd.isSelected() && getModel().getBPartner() != null
				&& getModel().getBPartner().isGroupInvoices()) {
			// Obtener el monto para actualizar los montos manuales de las facturas
			// El monto es lo que se encuentra en el text field de grupo, restando
    ...
    protected void updateSummaryInfo(){
    	...
    	txtDiscountAmt.setText(numberFormat(getCobroModel().getSumaDescuentos().negate()));
