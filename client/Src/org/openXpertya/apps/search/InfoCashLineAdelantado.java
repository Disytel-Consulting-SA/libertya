...
public class InfoCashLineAdelantado extends InfoCashLine {

	public InfoCashLineAdelantado(Frame frame, boolean modal, int WindowNo, String value, boolean multiSelection,
			String whereClause) {
	...
	protected BigDecimal getPaymentAmt(int i) {
		return (BigDecimal)p_table.getValueAt(i, 6);
	}
}
