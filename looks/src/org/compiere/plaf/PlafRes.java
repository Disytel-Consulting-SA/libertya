/*
 * @(#)PlafRes.java   12.oct 2007  Versión 2.2
 *
...
public class PlafRes extends ListResourceBundle {
    ...
    static final Object[][]	contents	= new String[][] {
        ...
        { "BackColType", "Background Color Type" }, { "BackColType_Flat", "Flat" }, { "BackColType_Gradient", "Gradient" }, { "BackColType_Lines", "Lines" }, { "BackColType_Texture", "Texture" },

        //
        { "LookAndFeelEditor", "Look & Feel Editor" }, { "LookAndFeel", "Look & Feel" }, { "Theme", "Theme" }, { "EditCompiereTheme", "Edit OpenXpertya Theme" }, { "SetDefault", "Default Background" }, { "SetDefaultColor", "Background Color" }, { "ColorBlind", "Color Deficiency" }, { "Example", "Example" }, { "Reset", "Reset" }, { "OK", "OK" }, { "Cancel", "Cancel" },
...
/*
 * @(#)PlafRes.java   02.jul 2007
 * 
 *  Fin del fichero PlafRes.java
 *  
